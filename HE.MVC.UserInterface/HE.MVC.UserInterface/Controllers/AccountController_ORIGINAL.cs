...
namespace HE.MVC.UserInterface.Controllers
{
    ...
    public class AccountController : HE_UI_ApiController
    {
        ...
        {
            #region Auto generated code from MVC Individual User Account template that I commented out
            if (ModelState.IsValid)
            {
            ...
            //try
            //{
            //    using (var client = new HttpClient { BaseAddress = new Uri(_apiUri) })
            //    {
            ...
            //        {
            //            Uri aUri = response.Headers.Location;
            //            return RedirectToAction("Index", "Home");
            //        }
            //        else
            //        {
        ...
        //NOT sure if this is needed here OR if I need to do an API call here to 
