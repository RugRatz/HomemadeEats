...
namespace HE.WebApp.UserInterface
{
    ...
    public class ApplicationUserManager : UserManager<CustomerProfile>
    {
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) 
        {
            ...
            manager.RegisterTwoFactorProvider("Phone Code", new PhoneNumberTokenProvider<CustomerProfile>
            {
                MessageFormat = "Your security code is {0}"
            });
            manager.RegisterTwoFactorProvider("Email Code", new EmailTokenProvider<CustomerProfile>
            {
            ...
            if (dataProtectionProvider != null)
            {
                manager.UserTokenProvider = 
                    new DataProtectorTokenProvider<CustomerProfile>(dataProtectionProvider.Create("ASP.NET Identity"));
            }
            return manager;
        }
    ...
    public class ApplicationSignInManager : SignInManager<CustomerProfile, string>
    {
        ...
        public override Task<ClaimsIdentity> CreateUserIdentityAsync(CustomerProfile user)
        {
